...
from .window import RedCarpetWindow
...
class RedCarpetApplication(Adw.Application):
    ...
    def do_activate(self):
        ...
        necessary.
        """
        self.win: RedCarpetWindow = self.props.active_window
        if not self.win:
            self.win = RedCarpetWindow(application=self,
    ...
    def on_preferences_action(self, *_args):
        ...
        self.win.show_preferences()
        
    def show_about_window(self, *_args):
        """Callback for the app.about action."""
        about = Adw.AboutWindow(
            transient_for=self.props.active_window,
            application_name=_("Red Carpet"),
